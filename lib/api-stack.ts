...
export class ApiStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: ApiStackProps) {
        ...
        // Create HTTP API
        this.httpApi = new apigw2.HttpApi(this, `${config.projectName}-${config.stage}-api`, {
        ...
        const adminAuthFn = new NodejsFunction(this, `${config.projectName}-${config.stage}-admin-authorizer-lambda`, {
        ...
        const userAuthFn = new NodejsFunction(this, `${config.projectName}-user-authorizer`, {
        ...
        this.userAuthorizer = new HttpLambdaAuthorizer(`${config.projectName}-user-authorizer`, userAuthFn, {
            responseTypes: [HttpLambdaResponseType.SIMPLE],
        })
