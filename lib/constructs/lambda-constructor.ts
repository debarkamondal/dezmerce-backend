...
export class ApiLambdaConstructor extends Construct {
    ...
    constructor(scope: Construct, id: string, props: LambdaFunctionProps) {
        ...
        const serviceRole = new iam.Role(this, `${props.projectName}-${props.stage}-lambda-role`, {
        ...
        console.log(join(__dirname, "../../bun.lock"))
        this.lambdaFunction = new NodejsFunction(this, `${props.projectName}-${props.name}-lambda`, {
